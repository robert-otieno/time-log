...
export const notificationSchema = z.discriminatedUnion("type", [
  ...
  z.object({ ...common, type: z.literal("mention"), projectId: id, taskId: id.optional(), commentId: id.optional(), templateData: z.object({ projectName: name, authorName: name, contextLabel: title, targetUrl: url }).strict() }).strict(),
  ...
  z.object({ ...common, type: z.literal("announcement"), projectId: id, messageId: id, templateData: z.object({ projectName: name, announcementTitle: title, authorName: name, targetUrl: url }).strict() }).strict(),
