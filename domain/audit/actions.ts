export const AUDIT_ACTIONS = [
  ...
  "time.timer.resumed",
  "time.timer.stopped",
  "time.timer.alarm.configured",
  "time.timer.alarm.triggered",
  "time.timer.alarm.dismissed",
  "time.timer.alarm.snoozed",
  "time.entry.created",
...
export const AUDIT_CHANGE_ALLOWLIST = {
  ...
  "user.preferences.updated": ["timezoneChanged", "notificationPreferencesChanged", "workTargetChanged"] as const,
  ...
  "project.assignment.created": ["membershipStatus"] as const,
  "project.assignment.removed": ["membershipStatus"] as const,
  ...
  "time.timer.alarm.configured": NONE,
  "time.timer.alarm.triggered": NONE,
  "time.timer.alarm.dismissed": NONE,
  "time.timer.alarm.snoozed": NONE,
  ...
  "message.post.created": ["visibility"] as const,
  "message.post.updated": NONE,
  "message.post.pinned": ["enabled"] as const,
  "message.post.unpinned": ["enabled"] as const,
  "message.post.archived": STATUS,
  "message.post.restored": STATUS,
  "message.comment.created": ["visibility"] as const,
  "message.comment.updated": NONE,
  "message.comment.archived": STATUS,
  ...
  "notification.job.completed": ["outcome"] as const,
  "notification.job.failed": ["outcome"] as const,
