...
const member = (uid: string, role = "member") => ({ userId: uid, role, status: "active", clientId: role === "client" ? "c1" : null, joinedAt: timestamp });
...
function environment(extra: Record<string, Record<string, unknown>> = {}) {
  const records: Record<string, Record<string, unknown>> = { "organizations/o1/members/u1": member("u1"), "organizations/o1/projects/p1/projectMembers/u1": assignment("u1"), "organizations/o1/projects/p1": project, ...extra };
