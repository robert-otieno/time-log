...
import { canAccessProject, canReadVisibility, hasCapability } from "@/domain/organizations/policy";
...
const assignment = (userId: string): ProjectAssignment => ({ userId, status: "active", assignedBy: "admin-user", assignedAt: timestamp, removedAt: null });
