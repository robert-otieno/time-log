...
- A timer may carry one tracked-time reminder. Paused time does not advance it; dismissing or snoozing never stops the timer. Initial browser notifications require explicit permission and an open browser session.
